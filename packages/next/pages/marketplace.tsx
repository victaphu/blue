    ...
    return (
        <div className="flex flex-col min-h-full items-center justify-center px-4 sm:px-6 lg:px-8 p-4">
            ...
            {Object.keys(accessories).length > 0 && <>
                ...
                <div className='overflow-scroll px-2 bg-purple-200 rounded-xl my-4'>
            ...
            <div className="bg-purple-500 rounded-xl my-2 p-2 w-full items-center justify-center flex flex-col">
